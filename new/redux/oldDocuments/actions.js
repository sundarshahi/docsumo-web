...
export const OLD_KEY = 'OLD_DOCUMENTS';
...
export const actionTypes = {
  ...
  RT_DOCUMENT_DATA_FETCH: `${OLD_KEY}_RT_DOCUMENT_DATA_FETCH`,
  RT_DOCUMENT_DATA_LOAD_FETCH: `${OLD_KEY}_RT_DOCUMENT_DATA_LOAD_FETCH`,
  ...
  RT_GO_TO_DOCUMENT: `${OLD_KEY}_RT_GO_TO_DOCUMENT`,
  ...
  RT_LINE_ITEMS_ADD_LINE: `${OLD_KEY}_RT_LINE_ITEMS_ADD_LINE`,
  ...
  RT_LINE_ITEMS_MANAGE_GRID: `${OLD_KEY}_RT_LINE_ITEMS_MANAGE_GRID`,
  ...
  RT_LINE_ITEMS_ADD_SIMILAR_LINES: `${OLD_KEY}_RT_LINE_ITEMS_ADD_SIMILAR_LINES`,
  ...
  RT_LINE_ITEMS_DELETE_ROW: `${OLD_KEY}_RT_LINE_ITEMS_DELETE_ROW`,
  RT_LINE_ITEMS_DELETE_ALL_ROWS: `${OLD_KEY}_RT_LINE_ITEMS_DELETE_ALL_ROWS`,
  ADD_SEARCH_QUERY: `${KEY}_ADD_SEARCH_QUERY`,
  RT_LINE_ITEMS_DELETE_FIELDS: `${OLD_KEY}_RT_LINE_ITEMS_DELETE_FIELDS`,
  ...
  RT_LINE_ITEM_DROP_DOWN_FETCH: `${OLD_KEY}_RT_LINE_ITEM_DROP_DOWN_FETCH`,
...
export const actions = {
  ...
  handleGridDrag: createAction(
    actionTypes.HANDLE_GRID_DRAG,
    payloadPassthrough
  ),
