...
class CreditActivityPage extends Component {
  state = {
  ...
  componentWillUnmount() {
    this.props.activityActions.creditActivityReset();
  }
  ...
  fetchDocuments = (pageQueryParams) => {
    ...
    activityActions.creditActivityFetch({
      queryParams,
    });
  };
  ...
  renderDocumentList = ({ showSkeletonView }) => {
    const { creditActivity, appActions } = this.props;
  ...
  render() {
    const { isFetchingDocuments, fetchFailed, fetchSucceeded, creditActivity } =
      this.props;

    const hasDocuments = !_.isEmpty(creditActivity);
    ...
    return (
      <Fragment>
        <PageMetadata title='Credit Activity' />
        ...
        {/* <Dropzone
                    ...
                    activeClassName={styles.dropzoneIsActive}
                ...
                >
                    ...
                    { showSkeletonView ? <SkeletonView/> : null }
                    ...
                    { showPaginaiton ? (
                        <PageFooter className={styles.footer}>
                            <Pagination
                                ...
                                onNavigateToPage={this.handlePageNavigation}
                            />
                        </PageFooter>
                    ) : null }
                </Dropzone> */}
...
function mapStateToProp(state) {
  const { creditActivity, meta, fetchState } = state.activities.creditActivity;
...
export default connect(mapStateToProp, mapDispatchToProps)(CreditActivityPage);
