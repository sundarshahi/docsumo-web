...
export class StaticTooltip extends React.Component {
  ...
  render() {
    const {
      ...
      className = '',
      staticTooltipLabel = '',
      hasUnassignTooltip = false,
      hasErrorTooltip = false,
      ...
      >
        <div
          className={cx(
            ...
            hasUnassignTooltip && styles.unassignTooltipContainer,
            hasErrorTooltip && styles.errorTooltipContainer
          )}
        >
          <div className={styles.content}>
            {description && (
              <p
                className={cx(
                  styles.contentText,
                  hasUnassignTooltip && styles.unassignTooltipText,
                  hasErrorTooltip && styles.errorTooltipText
                )}
              >
                {description}
              </p>
          ...
          {showStaticTooltip && (
            <div className={styles.staticTooltip}>
              {staticTooltipLabel}
              <span
                className={styles.staticTooltip__arrow}
                data-tooltip-arrow
              />
            </div>
          )}
