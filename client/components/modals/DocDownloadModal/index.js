...
// import DateFilter from '../../pages/ProcessedDocumentsPage/DateFilter.js';
import _ from 'lodash';
import mixpanel from 'mixpanel-browser';
import Dropzone from 'react-dropzone';
//import { IconButton , APPEARANCES as BUTTON_APPEARANCES} from 'components/widgets/iconButtons';
import Modal from 'react-responsive-modal';

import { ModalContent, ModalHeader } from 'components/shared/Modal';
      ...
      <Fragment>
        ...
        <Modal
          classNames={{
            ...
            modal: cx(styles.modal, styles.modalHalf),
        ...
        >
          ...
          <ModalContent className={styles.modalContent}>
                ...
                {/* {!singleDoc &&
                            <Cell className={styles.cell}>
                                <DateFilter
                                    ...
                                    btnClassName={styles.btnDateFilter}
                                    ranges={this.dateFilterRanges}
                                    activeRange={activeFileDateFilterRanges['created_date']}
                                    onBtnClick={this.handleDateFilterBtnClick}
                                    onRangeClick={(range) => this.handleFileDateFilterRangeClick('created_date', range)}
                                />
                                
                                <Cell className={styles.warning}> * To download the documents there must be atleast one processed document.</Cell>
              ...
              {/* {!singleDoc &&
                            <Cell className={styles.cell}>
                                <DateFilter
                                    ...
                                    ranges={this.dateFilterRanges}
                                    btnClassName={styles.btnDateFilter}
                                    activeRange={activeDateFilterRanges['created_date']}
                                    onBtnClick={this.handleDateFilterBtnClick}
                                    onRangeClick={(range) => this.handleCSVDateFilterRangeClick('created_date', range)}
                                />
            ...
            {singleDoc ? (
              <>
                {/* <Row className={cx(styles.row,styles.downloadRow, {[styles.halfDownloadRow] : singleDoc})}> */}
                {/* <Cell>
                                Download XML :
                                    </Cell> */}
                {/* {!singleDoc &&
                                    <Cell className={styles.cell}>
                                        <DateFilter
                                            ...
                                            btnClassName={styles.btnDateFilter}
                                            ranges={this.dateFilterRanges}
                                            activeRange={activeXMLDateFilterRanges['created_date']}
                                            onBtnClick={this.handleDateFilterBtnClick}
                                            onRangeClick={(range) => this.handleXMLDateFilterRangeClick('created_date', range)}
                                        />
                ...
                {/* <Cell className={styles.cell}>
                                        <Button
                                            ...
                                            className={styles.btn}
                                            disabled={!!(disablDownload)}
                                            onClick={()=>this.handleDownloadBtnClick('xml')}
                                        >
                                    Download
                                        </Button>
                                    </Cell> */}
                  ...
                  {/* {!singleDoc &&
                                    <Cell className={styles.cell}>
                                        <DateFilter
                                            ...
                                            btnClassName={styles.btnDateFilter}
                                            ranges={this.dateFilterRanges}
                                            activeRange={activeJSONDateFilterRanges['created_date']}
                                            onBtnClick={this.handleDateFilterBtnClick}
                                            onRangeClick={(range) => this.handleJSONDateFilterRangeClick('created_date', range)}
                                        />
                ...
                {/* {!singleDoc &&
                                    <Cell className={styles.cell}>
                                        <DateFilter
                                            ...
                                            btnClassName={styles.btnDateFilter}
                                            ranges={this.dateFilterRanges}
                                            activeRange={activeExcelDateFilterRanges['created_date']}
                                            onBtnClick={this.handleDateFilterBtnClick}
                                            onRangeClick={(range) => this.handleExcelDateFilterRangeClick('created_date', range)}
                                        />
            ...
            {/* { config && !singleDoc ? 
                            ...
                            <Row className={styles.row}>
                                <Cell className={styles.cellTitle}>
                                    API Key :
                                </Cell>
                                <Cell className={styles.cellField}>
                                    <div className={styles.apiWrapper}>
                                        <Cell className={styles.input}>{config?config.docsumoApiKey:''}</Cell>
                                        <p className={styles.hintText}>
                                            <a href={config?config.docsumoApiDocumentationUrl:''} target="_blank">
                                                API documentation
                                            </a>
                                        </p>
                                    </div>
                                ...
                                <Cell>
                                    <IconButton
                                        ...
                                        onClick={()=>this.handleCopyText(config.docsumoApiKey)}
                                    />
                                </Cell>
                                <Cell className={cx(styles.cell,styles.apiBtn)}>
                                    <Button
                                        ...
                                        text="Refresh"
                                        className={styles.btn}
                                        onClick={this.handleApiKeyRefreshButtonClick}
                                    />
                                </Cell>
                            </Row>
                            <Row className={styles.row}>
                                    ...
                                    >
                                        { isEditingWebhookUrl ? (
                                            <Button
                                                ...
                                                text="Done"
                                                className={styles.btn}
                                                onClick={this.handleWebhookInputSubmit}
                                            />
                                        ) : (
                                            <Button
                                                iconLeft={EditIcon}
